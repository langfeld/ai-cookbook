...
const dataCategories = computed(() => [
  ...
  },
  {
    ...
    description: 'Zutaten-Aliase und geblockte Zutaten aller Benutzer exportieren/importieren.',
    icon: Link,
    bgClass: 'bg-violet-50 dark:bg-violet-900/30',
    iconClass: 'text-violet-600 dark:text-violet-400',
    count: counts.value.aliases + counts.value.blockedIngredients,
...
async function fetchCounts() {
  try {
    ...
    counts.value = {
      ...
      blockedIngredients: stats.blocked_ingredients || 0,
